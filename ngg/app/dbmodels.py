...
class Tpipe(models.Model):
    ...
    field_translation = models.CharField(
        max_length=255, db_collation="SQL_Latin1_General_CP1_CI_AS"
    )
...
class Tpipes(models.Model):
    ...
    field_id = models.IntegerField()
    field_translate = models.CharField(
        max_length=20, db_collation="SQL_Latin1_General_CP1_CI_AS"
    )
...
class AuthGroup(models.Model):
    name = models.CharField(
        unique=True, max_length=150, db_collation="SQL_Latin1_General_CP1_CI_AS"
    )
...
class AuthUser(models.Model):
    password = models.CharField(
        max_length=128, db_collation="SQL_Latin1_General_CP1_CI_AS"
    )
    ...
    first_name = models.CharField(
        max_length=150, db_collation="SQL_Latin1_General_CP1_CI_AS"
    )
    last_name = models.CharField(
        max_length=150, db_collation="SQL_Latin1_General_CP1_CI_AS"
    )
    email = models.CharField(
        max_length=254, db_collation="SQL_Latin1_General_CP1_CI_AS"
    )
...
class AuthtokenToken(models.Model):
    key = models.CharField(
        primary_key=True, max_length=40, db_collation="SQL_Latin1_General_CP1_CI_AS"
    )
